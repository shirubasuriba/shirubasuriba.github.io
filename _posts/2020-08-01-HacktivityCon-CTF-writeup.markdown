...
>>>a.read()
```
![Ladybug](/images/Hackivitycon-CTF/flag.PNG)
...
![bite](/images/Hackivitycon-CTF/bite.PNG)
...
![GIJoe](/images/Hackivitycon-CTF/GIJoe.PNG)
...
```
然後就能拿到admin的password
```admin:NT7b#ed4$J?eZ#m_```
再去Login就有flag了
